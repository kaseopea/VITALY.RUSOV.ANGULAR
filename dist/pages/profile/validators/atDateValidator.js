...
// =====================================================================================================================
(function () {
    var atDateValidatorFunc = function atDateValidatorFunc(CONST_VALIDATORS) {
        return {
            require: 'ngModel',
            restrict: 'A',
            link: function link(scope, elem, attrs, ctrl) {
                ...
                ctrl.$validators.dateValidator = function (modelValue) {
                    var formatPlus = attrs['dateFormat'].toLowerCase().replace('dd', 'd').replace('mm', 'm').toUpperCase();
